"""Eval set v4 generator — MIRRORS the 8 official Track 1 categories (practice-task style).

Each task gets the most deterministic grader possible:
  - exact         : one of the answer strings appears (boundary-aware)
  ...
  - judge         : an independent LLM (gemma3:12b) vs a reference (summarisation)

Run:  python -m eval.gen_tasks_v4  ->  eval/tasks_v4.jsonl
"""
